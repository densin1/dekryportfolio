...
const DK_CONTENT = {
  ...
  uk: {
    ...
    videoProjects: [
      ...
      { id: 'proj-8', category: 'youtube', title: 'YouTube відео: Топ способів заробітку', desc: 'Динамічне інтро та B-Roll нарізка про способи заробітку. Повний цикл: монтаж, моушн-дизайн (2D/3D), кінетична типографіка та акцентний саунд-дизайн.', thumb: 'img/project-8.jpg', video: 'video/project-8-preview.mp4', tags: ['DaVinci Resolve', 'Motion Graphics', 'Sound Design', 'B-Roll Edit'], link: 'https://t.me/des1n' }
    ],
  ...
  en: {
    ...
    videoProjects: [
      { id: 'proj-1', category: 'reels',   title: 'Dynamic Reels for a blogger',        desc: 'Fast-paced edit synced to trending audio, sound design, dynamic transitions.',                    thumb: 'img/project-1.jpg', video: 'video/project-1-preview.mp4', tags: ['DaVinci Resolve', 'After Effects', 'Sound Design'], link: 'https://t.me/des1n' },
      { id: 'proj-2', category: 'reels',   title: 'Reels series for a personal brand',  desc: 'A package of 12 videos. Trending sounds, subtitles. Follower growth +30%.',                       thumb: 'img/project-2.jpg', video: 'video/project-2-preview.mp4', tags: ['Trending Audio', 'Fast Turnaround'],                 link: 'https://t.me/des1n' },
      { id: 'proj-4', category: 'reels',   title: 'Creative Reels for advertising',     desc: 'Bold transitions, on-screen text, grabbing attention from the first second.',                     thumb: 'img/project-4.jpg', video: 'video/project-4-preview.mp4', tags: ['DaVinci Resolve', 'Ads'],                            link: 'https://t.me/des1n' },
      { id: 'proj-5', category: 'reels',   title: 'Analytics in Reels format',          desc: 'Complex data turned into an accessible short-form video with kinetic typography.',                thumb: 'img/project-5.jpg', video: 'video/project-5-preview.mp4', tags: ['After Effects', 'Kinetic Typography'],               link: 'https://t.me/des1n' },
      { id: 'proj-6', category: 'reels',   title: 'Reels for an expert',                desc: 'Talking-head footage + dynamic B-roll illustrating the narration.',                                thumb: 'img/project-6.jpg', video: 'video/project-6-preview.mp4', tags: ['Premiere Pro', 'B-roll'],                            link: 'https://t.me/des1n' },
      { id: 'proj-7', category: 'reels',   title: 'Product unboxing Reels',             desc: 'Bold transitions, on-screen text, grabbing attention from the first second. Rhythmic edit synced to music.', thumb: 'img/project-7.jpg', video: 'video/project-7-preview.mp4', tags: ['DaVinci Resolve', 'Product'],                        link: 'https://t.me/des1n' },
      { id: 'proj-3', category: 'youtube', title: 'YouTube video',       desc: 'Full cycle: editing, color grading, graphics, sound design. 65% audience retention.',        thumb: 'img/project-3.jpg', video: 'video/project-3-preview.mp4', tags: ['Premiere Pro', 'Color Grading', 'Motion Graphics'], link: 'https://t.me/des1n' },
      { id: 'proj-8', category: 'youtube', title: 'YouTube Video: Top Ways to Earn Money', desc: 'Dynamic intro and B-roll cuts about ways to make money. Full cycle: editing, motion design (2D/3D), kinetic typography, and accent sound design.', thumb: 'img/project-8.jpg', video: 'video/project-8-preview.mp4', tags: ['DaVinci Resolve', 'Motion Graphics', 'Sound Design', 'B-Roll Edit'], link: 'https://t.me/des1n' }
    ],

    designProjects: [
      { id: 'des-1', title: 'YouTube channel banner', tool: 'Figma, Photoshop', thumb: 'img/design-1.jpg', link: 'https://t.me/des1n' },
      { id: 'des-2', title: 'Ad creative for Facebook/Instagram', tool: 'Photoshop, Illustrator', thumb: 'img/design-2.jpg', link: 'https://t.me/des1n' },
      { id: 'des-3', title: 'Podcast cover art', tool: 'Figma, Photoshop', thumb: 'img/design-3.jpg', link: 'https://t.me/des1n' },
      { id: 'des-4', title: 'Identity for a personal brand', tool: 'Figma, Illustrator', thumb: 'img/design-4.jpg', link: 'https://t.me/des1n' }
    ],
  ...
  ru: {
    ...
    videoProjects: [
      { id: 'proj-1', category: 'reels',   title: 'Динамичный Reels для блогера',        desc: 'Быстрый монтаж под трендовое аудио, звуковой дизайн, динамичные переходы.',                      thumb: 'img/project-1.jpg', video: 'video/project-1-preview.mp4', tags: ['DaVinci Resolve', 'After Effects', 'Sound Design'], link: 'https://t.me/des1n' },
      { id: 'proj-2', category: 'reels',   title: 'Серия Reels для личного бренда',      desc: 'Пакет из 12 роликов. Трендовые звуки, субтитры. Рост подписчиков +30%.',                         thumb: 'img/project-2.jpg', video: 'video/project-2-preview.mp4', tags: ['Trending Audio', 'Fast Turnaround'],                 link: 'https://t.me/des1n' },
      { id: 'proj-4', category: 'reels',   title: 'Креативный Reels для рекламы',        desc: 'Яркие переходы, текст на экране, удержание внимания с первых секунд.',                           thumb: 'img/project-4.jpg', video: 'video/project-4-preview.mp4', tags: ['DaVinci Resolve', 'Ads'],                            link: 'https://t.me/des1n' },
      { id: 'proj-5', category: 'reels',   title: 'Аналитика в формате Reels',           desc: 'Сложные данные превращены в доступный короткий формат с кинетической типографикой.',              thumb: 'img/project-5.jpg', video: 'video/project-5-preview.mp4', tags: ['After Effects', 'Kinetic Typography'],               link: 'https://t.me/des1n' },
      { id: 'proj-6', category: 'reels',   title: 'Reels для эксперта',                  desc: 'Говорящая голова + динамические подкадры, иллюстрирующие текст.',                                 thumb: 'img/project-6.jpg', video: 'video/project-6-preview.mp4', tags: ['Premiere Pro', 'B-roll'],                            link: 'https://t.me/des1n' },
      { id: 'proj-7', category: 'reels',   title: 'Reels-распаковка продукта',           desc: 'Яркие переходы, текст на экране, удержание внимания с первых секунд. Ритмичный монтаж под музыку.', thumb: 'img/project-7.jpg', video: 'video/project-7-preview.mp4', tags: ['DaVinci Resolve', 'Product'],                        link: 'https://t.me/des1n' },
      { id: 'proj-3', category: 'youtube', title: 'YouTube видео',       desc: 'Полный цикл: монтаж, цветокоррекция, графика, саунд-дизайн. Удержание аудитории 65%.',     thumb: 'img/project-3.jpg', video: 'video/project-3-preview.mp4', tags: ['Premiere Pro', 'Color Grading', 'Motion Graphics'], link: 'https://t.me/des1n' },
      { id: 'proj-8', category: 'youtube', title: 'YouTube видео: Топ способов заработка', desc: 'Динамичное интро и B-Roll нарезка о способах заработка. Полный цикл: монтаж, моушн-дизайн (2D/3D), кинетическая типографика и акцентный саунд-дизайн.', thumb: 'img/project-8.jpg', video: 'video/project-8-preview.mp4', tags: ['DaVinci Resolve', 'Motion Graphics', 'Sound Design', 'B-Roll Edit'], link: 'https://t.me/des1n' }
    ],

    designProjects: [
      { id: 'des-1', title: 'Баннер для YouTube-канала', tool: 'Figma, Photoshop', thumb: 'img/design-1.jpg', link: 'https://t.me/des1n' },
      { id: 'des-2', title: 'Рекламный креатив для Facebook/Instagram', tool: 'Photoshop, Illustrator', thumb: 'img/design-2.jpg', link: 'https://t.me/des1n' },
      { id: 'des-3', title: 'Обложка для подкаста', tool: 'Figma, Photoshop', thumb: 'img/design-3.jpg', link: 'https://t.me/des1n' },
      { id: 'des-4', title: 'Айдентика для личного бренда', tool: 'Figma, Illustrator', thumb: 'img/design-4.jpg', link: 'https://t.me/des1n' }
    ],
